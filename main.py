...
## suni jo bhi llikh rhi comment krke likho
#ctrl and / dabao ek sath apne aap # symbol a jayenga

# ohh haa
# kafi sahi feature h na
# karo

#suni mao ek nyi file open krne ja raha ese folder ki and dekhte h usme bhi sath me kaam kr sakte h ya nhin ok
...
def main():
    ...
    while True:
        ...
        if user_command in ["Could not recognize", "Listening failed", "Speech service not available."]:
            continue  # कुछ बोले बिना फिर से listen करेगा
